...
def testlist():
    frm = Question('Який вид спорту вважається найдавнішим у світі?', 'Боротьба', 'Футбол', 'Легка атлетика', 'Плавання')
    questions_listmodel.form_list.append(frm)
    frm = Question('Який елемент є найбільш поширеним у Всесвіті?', 'Водень', 'Кисень', 'Азот', 'Гелій')
    questions_listmodel.form_list.append(frm)
    frm = Question('Яке місто вважається найстарішим постійно заселеним містом у світі?', 'Єрихон', 'Афіни', 'Рим', 'Багдад')
    questions_listmodel.form_list.append(frm)
    frm = Question('Яка річка є найдовшою у світі?', 'Ніл', 'Амазонка', 'Міссісіпі', 'Янцзи')
    questions_listmodel.form_list.append(frm)
    frm = Question('Яка хімічна речовина надає листям зелений колір?', 'Хлорофіл', 'Гемоглобін', 'Кератин', 'Меланін')
    questions_listmodel.form_list.append(frm)
    frm = Question('Яка тварина є найбільшим ссавцем на планеті?', 'Синій кит', 'Африканський слон', 'Білий ведмідь', 'Жираф')
    questions_listmodel.form_list.append(frm)
    frm = Question('Яке місто є столицею Австралії?', 'Канберра', 'Сідней', 'Мельбурн', 'Брісбен')
    questions_listmodel.form_list.append(frm)
